...
int main(int argc, char *argv[], char *envp[])
{
  ...
  a.setStyleSheet("#centralWidget{border-image: url(:/tomato/png/image/layer1-5.png);}" "/*QLCDNumber{}*/");
  MainWindow w;
  w.show();
...
int wmain(int argc, wchar_t *argv[], wchar_t *envp[])
{
  ...
  a.setStyleSheet("#centralWidget{border-image: url(:/tomato/png/image/layer1-5.png);}" "/*QLCDNumber{}*/");
  MainWindow w;
  //w.setStyleSheet("#centralWidget{border-image: url(:/tomato/png/image/layer1-5.png);}");
  w.show();
